                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected
                            ? 'bg-aqua-50 text-aqua-700 dark:bg-aqua-950/30 dark:text-aqua-300'
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isSelected ? 'bg-aqua-100 dark:bg-aqua-900/30' : 'bg-muted'
                          )}
                        >
                          <Icon
                            className={cn(
                        ...
                        {cmd.shortcut && (
                          <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground bg-muted border border-border rounded flex-shrink-0">
                            {cmd.shortcut}
                          </kbd>
                        )}
                        {isSelected && (
