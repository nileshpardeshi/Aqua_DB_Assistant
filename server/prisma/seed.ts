  ...
  const rules = [
    {
      ...
      configuration: JSON.stringify({
        ...
        conditions: [
          { column: 'status', operator: 'IN', value: "'completed','reversed'", conjunction: 'AND' },
        ],
        priority: 'critical',
        cascadeDelete: false,
    ...
    {
      ruleName: 'Expired Session Cleanup',
      ruleType: 'retention',
      targetTable: 'user_sessions',
      targetColumns: 'last_login_at',
      isActive: true,
      configuration: JSON.stringify({
        retentionPeriod: 30,
        retentionUnit: 'days',
        ...
        conditions: [
          { column: 'status', operator: '=', value: 'expired', conjunction: 'AND' },
        ],
        priority: 'medium',
        cascadeDelete: false,
    ...
    },
    {
      ...
      ruleType: 'retention',
      targetTable: 'accounts',
      targetColumns: 'closed_at',
      isActive: false,
      configuration: JSON.stringify({
        retentionPeriod: 5,
        retentionUnit: 'years',
        retentionColumn: 'closed_at',
        conditions: [
          { column: 'status', operator: '=', value: 'closed', conjunction: 'AND' },
        ],
        priority: 'high',
        cascadeDelete: true,
        backupBeforePurge: true,
    ...
    },
    {
      ...
      ruleType: 'retention',
      targetTable: 'loans',
      targetColumns: 'maturity_date',
      isActive: true,
      configuration: JSON.stringify({
        retentionPeriod: 7,
        retentionUnit: 'years',
        retentionColumn: 'maturity_date',
        conditions: [
          { column: 'status', operator: '=', value: 'paid_off', conjunction: 'AND' },
        ],
        priority: 'medium',
        cascadeDelete: false,
        backupBeforePurge: true,
